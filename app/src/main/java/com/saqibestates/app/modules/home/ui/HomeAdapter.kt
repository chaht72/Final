package com.saqibestates.app.modules.home.ui
...
import com.saqibestates.app.databinding.RowHomeBinding
import com.saqibestates.app.modules.home.`data`.model.HomeRowModel
import kotlin.Int
...
class HomeAdapter(
  ...
  inner class RowHomeVH(
    ...
    init {
      binding.btnFixtureReplacement.setOnClickListener {
