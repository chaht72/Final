...
class SpinnerDecemberCounterAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerDecemberCounterModel>
) : ArrayAdapter<SpinnerDecemberCounterModel>(mContext, layoutResource, allItems) {
